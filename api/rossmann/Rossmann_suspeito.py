...
class Rossmann( object ):
    def __init__( self ):
        self.competition_distance_scaler   = pickle.load(open('/home/naomi/repos/ds-em-producao/parameter/competition_distance_scaler.pkl', 'rb'))
        self.competition_time_month_scaler = pickle.load(open('/home/naomi/repos/ds-em-producao/parameter/competition_time_month_scaler.pkl', 'rb'))
        self.promo_time_week_scaler        = pickle.load(open('/home/naomi/repos/ds-em-producao/parameter/promo_time_week_scaler.pkl', 'rb'))
        self.year_scaler                   = pickle.load(open('/home/naomi/repos/ds-em-producao/parameter/year_scaler.pkl', 'rb'))
        self.store_type_encoding           = pickle.load(open('/home/naomi/repos/ds-em-producao/parameter/store_type_encoding.pkl', 'rb'))
    ...
    def data_cleaning( self, df1 ):
        ...
        df1['promo2_sin ce_year'] = df1['promo2_since_year'].astype(int)
